...
/*    ini_set('display_errors', 1);
    ...
    class Panel extends CI_Controller {
        ...
        public function manegetabs() {
            ...
            $user = $this->MainModel->detail('student', 'name');
        ...
        public function add_user()
        {
            ...
            if($this->input->post('submit'))
            {
            	...
            	else
            	{
	            	...
	            	$array_data = array('name' => $name,
	            	'email' => $email );
	            	$table = "student";
	            	$res = $this->MainModel->add($table, $array_data);
	                $response['details'] = $res;
	                if($res) {
            ...
            $response['title_'] = 'User';
            $response['title_dynamic'] = 'user';
            $response['dashboard'] = '';
            $response['maasemail'] = '';
            $response['manegetabs'] = '';
            ...
            $this->load->view('panel/template/head');
            $this->load->view('panel/template/header', $response);
            $this->load->view('panel/pages/user/add');
            $this->load->view('panel/template/footer');
            $this->load->view('panel/template/foot');
        ...
        {
        	if($this->input->post('deleteone'))
        	{
        		$tbl = "student";
        		$result = $this->MainModel->delete($tbl, $this->input->post('deleteone'));
        		if($result) {
	                    $this->session->set_flashdata('success','Selected row deleted successfully'); 
	            }else{
	                   $this->session->set_flashdata('error','Something went wrong');
	            }
        	}
        	...
        	{
	        	$tbl = "student";
	        	foreach ($this->input->post('chk') as $row) 
	        	{		
	        		$result = $this->MainModel->delete($tbl, $row);
	        	}
	            if($result) {
	                    $this->session->set_flashdata('success','Selected row deleted successfully'); 
	            }else{
	        ...
	        else
	        {
	        	...
	        	{		
	        		$cond = array('id' => $row );
	        		$result = $this->MainModel->edit_($tbl, $cond);
                	...
                	$to = $result[0]['email'].", prasannam.bwd@gmail.com";
                	$subject ="mass mail";
	            ...
	            if($result) {
	                    $this->session->set_flashdata('success','Selected row mail sent successfully'); 
	            }else{
	                   $this->session->set_flashdata('error','Something went wrong');
	            }
        ...
        {
            $table = "student";
            $res = $this->MainModel->detail($table, 'name');
            ...
            $this->load->view('panel/template/head');
            $this->load->view('panel/template/header', $response);
            $this->load->view('panel/pages/user/display');
            $this->load->view('panel/template/footer');
            $this->load->view('panel/template/foot');

        }

        public function maasemail()
        {
            $table = "student";
            $res = $this->MainModel->detail($table, 'name');
        ...
        {
            $tbl = "student";
            $data = array('user_status' => 'Permission Granted');
            $cond = array('id' => $id );
            $result = $this->MainModel->update_data($cond, $data, $tbl);
            ...
            $resd = $this->MainModel->edit_($tbl, $cond);
                ...
                $from = "paziuk@viyra.com";
                $to = $resd[0]['email'].", prasannam.bwd@gmail.com";
                $subject ="Permission";
               
                $message = "Permission Granted For you";
                /*
               <br><a href='".$information."'>Need More information</a>
               <br><a href='".$denied."'>Permission denied</a>
...
*/
        ...
        {
            $tbl = "student";
            $data = array('user_status' => 'Permission denied');
            $cond = array('id' => $id );
            $result = $this->MainModel->update_data($cond, $data, $tbl);
            $resd = $this->MainModel->edit_($tbl, $cond);
            ...
            $message = "Permission denied of you";
               /*
               <br><a href='".$information."'>Need More information</a>
               <br><a href='".$denied."'>Permission denied</a>
               <br>New Customer Registered, Customer information, 
...
*/
        ...
        {
            $tbl = "student";
            $data = array('user_status' => 'Need More information');
            $cond = array('id' => $id );
            $result = $this->MainModel->update_data($cond, $data, $tbl);
...
*/
        ...
        public function subtab($id = 0)
        {
            ...
            if($this->input->post('name') != '')
            {
                ...
                $my_parent = $this->input->post('my_parent');
                $array_data = array(
                   'name' => $name,
                   'my_parent' => $my_parent
                ); 
            ...
            $res = $this->MainModel->manegetabs_byid($id);
            $response['title_'] = 'Sub Tabs';
            $response['title_dynamic'] = 'subtab';
            $response['user'] = '';
            $response['dashboard'] = '';
            $response['manegetabs'] = 'active';
            ...
            $this->load->view('panel/template/head');
            $this->load->view('panel/template/header', $response);
            $this->load->view('panel/pages/subtab/display');
            $this->load->view('panel/template/footer');
            $this->load->view('panel/template/foot');
        }
        ...
        public function managesubtabs($id = 0) 
        {
            ...
            if($id > 0) {
                ...
                $result = $this->MainModel->delete($tbl, $id);
                  if($result) {
                    $this->session->set_flashdata('success','New row deleted successfully'); 
                }else{
                    $this->session->set_flashdata('danger','Something went wrong');
                }
